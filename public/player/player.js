...
function markPuzzleSolved(roundId, message) {
  ...
  templePuzzleState.message = message || 'Puzzle solved. The next chamber can unlock.';
  ...
  if (key === 'torch') {
    return `
      <div class="escapeToolPanel">
        ...
        <div class="toolStatusRow"><b>Torch light size:</b><span>${getTorchSizeLabel()} · ${getTorchDiameter()}px</span></div>
...
function levelSummaryForRound(round, index = 0) {
  const summaries = [
    ...
    },
    {
      ...
      goal: 'Move your torch until the serpent shadow points to the breathing seal, then select that seal.',
      ...
      mechanic: 'Drag the torch across the black chamber wall until the serpent shadow reveals the correct seal, then choose that seal.'
    },
    {
