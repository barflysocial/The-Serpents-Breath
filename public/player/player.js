...
if ($('titleScreen')) {
  $('titleScreen').addEventListener('click', () => {
    clearTimeout(window.__titleStageTimer);
...
function startIntro() {
  ...
  if (window.__titleStageTimer) clearTimeout(window.__titleStageTimer);
  setIntroStage('splash');
  splashTimer = setTimeout(() => {
    setIntroStage('title');
    window.__titleStageTimer = setTimeout(() => setIntroStage('experience'), 2800);
  }, 2200);
}
...
// Build marker: serpent-logo-splash-before-title-005
